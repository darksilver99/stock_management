...
export 'product_tranfer_page_model.dart';

class ProductTranferPageWidget extends StatefulWidget {
  const ProductTranferPageWidget({super.key});

  @override
  State<ProductTranferPageWidget> createState() =>
      _ProductTranferPageWidgetState();
}

class _ProductTranferPageWidgetState extends State<ProductTranferPageWidget> {
  late ProductTranferPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductTranferPageModel());
  }
            ...
            children: [
              Expanded(
                child: PagedListView<DocumentSnapshot<Object?>?,
                  ...
                  builderDelegate: PagedChildBuilderDelegate<TranferListRecord>(
