                          ...
                          builder: (context) {
                            if (_model.isSearched) {
                              return RefreshIndicator(
                                key: Key('RefreshIndicator_r102vd3p'),
                                onRefresh: () async {
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        TextSpan(
                                                                          text:
                                                                              listViewTransactionListRecord.productName,
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: 'Inter',
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        TextSpan(
                                                                          text:
                                                                              formatNumber(
                                                                            listViewTransactionListRecord.totalAmount,
                                                                            formatType:
                                                                                FormatType.decimal,
                                                                            decimalType:
                              ...
                              return RefreshIndicator(
                                key: Key('RefreshIndicator_6kumeesf'),
                                onRefresh: () async {
                                  await actions.pushReplacement(
                                    context,
                                    'TransactionListPage',
